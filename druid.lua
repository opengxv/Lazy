    ...
    local actions = {
        ...
        ["other"] = {
            ...
            ['熊形态'] = {
                ...
                text = '/script Lazy:Stop()\n/stopcasting\n' .. LazyDruid:CancelAura(1) .. '/cast [nostance:1] 巨熊形态; [stance:1] 巨熊形态',
                key = 'R',
            },
            ['海豹形态'] = {
                text = '/script Lazy:Stop()\n/stopcasting\n' .. LazyDruid:CancelAura(2) .. '/cast [swimming]水栖形态\n/cast [noswimming]旅行形态',
                key = 'C',
            },
            ['猎豹形态'] = {
                text = '/script Lazy:Stop()\n/stopcasting\n' .. LazyDruid:CancelAura(3) .. '/cast [stance:3] 潜行\n/cast [nostance:3] 猎豹形态',
                key = 'F',
            },
            ["治疗他人"] = {
                text = '/script Lazy:Stop()\n' .. LazyDruid:CancelAura(0) .. '/script LazyDruid:Heal(Lazy.mouseover)',
                key = "MOUSEWHEELDOWN",
            },
            ["自我治疗"] = {
                text = '/script Lazy:Stop()\n' .. LazyDruid:CancelAura(0) .. '/script LazyDruid:Heal(Lazy.player)',
                key = "MOUSEWHEELUP",
            },
            ["骑乘"] = {
                text = LazyDruid:CancelAura(0) .. '/cast ' .. Lazy.mount,
                key = "F5",
            },
        },
    }
...
function LazyDruid:CancelAura(index)
    ...
    str = str .. '/cancelaura ' .. Lazy.mount_aura .. '\n'
    return str
end
